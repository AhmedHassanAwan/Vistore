...
export default function Testimonials() {
  return (
    <section className="bg-[#fafafa] px-4 py-16 mb-15">
      {/* Heading */}
      <div className="text-center max-w-2xl mx-auto mb-16">
        <p className="text-sm text-gray-500 mb-1">• Our Testimonial</p>
        <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-2">
      ...
      {/* Testimonial Block 1 */}
      <div className="flex flex-col md:flex-row justify-center items-center gap-6 border-b border-gray-200 pb-10 md:ml-35">
        {/* Left Stat */}
        ...
        {/* Card 1 */}
        <div className="bg-gray-50 p-6 rounded-xl shadow-sm max-w-md w-full mx-auto">
          <p className="text-gray-700 text-sm mb-4 leading-relaxed text-center md:text-left">
            Using GetCRM CRM is one of the best decisions we've ever made. We've <br />
            seen our annual revenue explode, and <br />
            the outlook just keeps getting sunnier.
          </p>
      ...
      {/* Testimonial Block 2 */}
      <div className="flex flex-col md:flex-row justify-center items-center gap-6 mt-10 md:ml-35">
        {/* Left Stat */}
        <div className="text-center md:text-left">
          <h3 className="text-4xl font-bold text-gray-900 mb-1">45%</h3>
          <p className="text-sm text-gray-500">Crew Revenue</p>
        </div>

        {/* Card 2 */}
        <div className="bg-gray-50 p-6 rounded-xl shadow-sm max-w-md w-full mx-auto">
          <p className="text-gray-700 text-sm mb-4 leading-relaxed text-center md:text-left">
            GetCRM CRM is created for people like us. It's the kind of software that just works. <br />
          ...
          <div className="flex items-center gap-4 justify-center md:justify-start">
            ...
            <div>
              <p className="font-semibold text-gray-800">Henry Jacks</p>
              <p className="text-xs text-gray-500">Digital Marketing Director</p>
            </div>
          </div>
        </div>
      </div>
