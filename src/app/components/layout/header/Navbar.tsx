...
export default function Navbar() {
  ...
  return (
      ...
      {/* Desktop Menu */}
      <div className="hidden md:flex items-center gap-50">
        ...
        <div className="flex items-center gap-4">
          ...
          <Link href="#" className="text-sm border px-4 py-3 rounded-full hover:bg-pink-200 hover:text-white">Sign up Free</Link>
        </div>
      </div>
      ...
      {/* Mobile Menu */}
      {menuOpen && (
        <div className="absolute top-16 left-0 w-full bg-pink-100 px-6 py-4 shadow-md flex flex-col gap-4 md:hidden z-50 justify-center items-center">
          ...
          <Link href="#" className="text-lg border px-4 py-2 rounded-full text-center  hover:bg-pink-200 hover:text-white ">Sign up Free</Link>
        </div>
      )}
    </nav>
  );
